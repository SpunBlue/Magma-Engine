...
class TitleState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		if (initialized && !transitioning && skippedIntro)
		{
			if(pressedEnter)
			{
				...
				new FlxTimer().start(1, function(tmr:FlxTimer)
				{
					if (UpdateCheckState.updateComplete == false)
						MusicBeatState.switchState(new UpdateCheckState());
					else
	...
	function createCoolText(textArray:Array<String>, ?offset:Float = 0)
	{
		for (i in 0...textArray.length)
		{
			...
			var money:FlxText = new FlxText(0, 0, 0, textArray[i].toUpperCase(), 48).setFormat(Paths.font("Anton-Regular.ttf"), 48, FlxColor.WHITE);
	...
	function addMoreText(text:String, ?offset:Float = 0)
	{
		if(textGroup != null && credGroup != null) {
			...
			var coolText:FlxText = new FlxText(0, 0, 0, text.toUpperCase(), 48).setFormat(Paths.font("Anton-Regular.ttf"), 48, FlxColor.fromRGB(243, 69, 115));
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['Magma Engine by'], 15);
				// credTextShit.visible = true;
				case 3:
					addMoreText('Studio Magma', 15);
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.screenCenter();
				case 13:
					addMoreText('You already');
				// credTextShit.visible = true;
				case 14:
					addMoreText('Know what it is');
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Dumbass'); // credTextShit.text += '\nFunkin';
